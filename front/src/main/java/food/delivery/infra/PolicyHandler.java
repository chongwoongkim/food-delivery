...
public class PolicyHandler{
    ...
    @StreamListener(value=KafkaProcessor.INPUT, condition="headers['type']=='CookFinshed'")
    public void wheneverCookFinshed_UpdateOrderStatus(@Payload CookFinshed cookFinshed){

        CookFinshed event = cookFinshed;
        System.out.println("\n\n##### listener UpdateOrderStatus : " + cookFinshed + "\n\n");
